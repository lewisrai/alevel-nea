...
enum class WeaponType { Gun, Sword };
...
class Weapon {
  public:
    ...
    // Method - checks weapon type and calls the update function for that weapon
    // type
    void UpdateWeapon(bool facingLeft, float deltaTime, int keyAttack, Rectangle rect,
  ...
  private:
    // Update Gun
    void UpdateGun(bool facingLeft, float deltaTime, bool keyAttackDown, Rectangle rect,
                   ProjectileList &projectiles);
    // Update Sword
