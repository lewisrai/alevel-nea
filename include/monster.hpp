...
enum class MonsterType { Normal, Strong };
...
// Randomly spawns monsters on top of blocks - difficulty increases as level
// increases
void GenerateEnemies(const SoundArray &sounds, const BlockList &blocks, MonsterList &enemies,
                     int level);
